...
# API Configuration
API_ID = int(os.environ.get("API_ID", "10534939"))
API_HASH = os.environ.get("API_HASH", "9c45b95093a13d3411201d14f7684066")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")

CREDIT = os.environ.get("CREDIT", "〱RＧ▕")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "8385924443")
ADMINS = [int(x) for x in os.environ.get("ADMINS", "8385924443").split()]  # Default to owner ID
